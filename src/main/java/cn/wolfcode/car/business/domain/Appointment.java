...
public class Appointment {
    ...
    public static final Integer CONCEAL_ON = 0; // 显示
    public static final Integer CONCEAL_OFF = 1; //隐藏
    private Long id;
    ...
    @JsonFormat(pattern = "yyyy-MM-dd HH:mm", timezone = "GMT+8") // 显示的时间格式
    @DateTimeFormat(pattern = "yyyy-MM-dd HH:mm")   //添加的时间格式
